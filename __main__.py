...
#     ref = db.reference('/')
    ...
    for link in linklist:
        ...
        r = requests.post(url, data=json.dumps(data), headers=headers, auth=('df002ee3-e362-4c12-b817-d3e70abcd959', 'hR78sr6OLfhnoysyhLYl8uILfP2pp49qwtUBsbCZnzJ5h9cRxDizI802iq8O9ius'))
